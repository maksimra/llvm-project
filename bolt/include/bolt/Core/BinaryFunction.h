...
public:
  ...
  /// Return true if this function contains a direct non-call branch into
  /// \p Target. This performs a read-only scan of the raw function contents
  /// and is only valid before regular disassembly.
  bool hasDirectBranchTo(const BinaryFunction &Target) const;
